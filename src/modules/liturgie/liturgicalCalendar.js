// Calcul approximatif du calendrier liturgique romain (rite ordinaire).
// L'Épiphanie est fixée au 6 janvier (et non reportée au dimanche) par
// simplification : les dates exactes peuvent donc différer localement de
// quelques jours autour de Noël/Épiphanie selon les usages diocésains -
// à corriger via les « particularités diocésaines » si besoin.
...
export function liturgicalSeasons(year) {
  const easter = computeEaster(year);
...
export function feastsForYear(year, diocesanFeasts = []) {
