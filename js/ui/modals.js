...
(function (gP) {
  ...
  function confirmModal(message, { title = 'Confirmation', confirmLabel = 'Confirmer', danger = false } = {}) {
  ...
  function openModal(bodyEl, options) {
  ...
  Object.assign(gP.ui, { mountModals, confirmModal, openModal });
})(window.gP);
